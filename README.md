# agilent-rs232
A basic script to read the waveform from an Agilent 54621A (Note: Has also been checked with 54622D and 54641A) oscilloscope via RS232 and display it using matplotlib.
